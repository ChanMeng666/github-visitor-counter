...
import { Settings, Palette, Tag, Eye } from "lucide-react";
...
import type { CounterConfig, ThemeName } from "@/lib/constants";
  ...
  return (
    <div className="space-y-6 h-full overflow-y-auto pr-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="flagsfrom">Show Flags From</Label>
            <Select
              value={config.flagsfrom}
              onValueChange={(value: any) => onChange({ ...config, flagsfrom: value })}
            >
              <SelectTrigger id="flagsfrom">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="showcount">Show Visitor Count</Label>
            <Switch
              id="showcount"
